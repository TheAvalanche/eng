...
public class AzureListenerTwo implements MessageListener {

    public AzureListenerTwo() throws Exception {
        ...
        MessageConsumer receiver = receiveSession.createDurableSubscriber(topic, "magentosub");
        receiver.setMessageListener(this);
        connection.start();
    }

    public static void main(String[] args) throws Exception {
        new AzureListenerTwo();
    }
